...
RSpec.describe Accounts::CreationForm, type: :form do
  it "アットネームが空文字列のとき、エラーになること" do
    form = Accounts::CreationForm.new(atname: "")
  ...
  it "アットネームが `nil` のとき、エラーになること" do
    form = Accounts::CreationForm.new(atname: nil)
  ...
  it "アットネームが21文字のとき、エラーになること" do
    form = Accounts::CreationForm.new(atname: "a" * 21)
  ...
  it "アットネームが予約語のとき、エラーになること" do
    form = Accounts::CreationForm.new(atname: "admin")
  ...
  it "アットネームの形式が不正なとき、エラーになること" do
    form = Accounts::CreationForm.new(atname: "a@b")
  ...
  it "アットネームがすでに使われているとき、エラーになること" do
    ...
    form = Accounts::CreationForm.new(atname: "a")
  ...
  it "メールアドレスが空文字列のとき、エラーになること" do
    form = Accounts::CreationForm.new(email: "")
  ...
  it "メールアドレスが `nil` のとき、エラーになること" do
    form = Accounts::CreationForm.new(email: nil)
  ...
  it "メールアドレスの形式が不正なとき、エラーになること" do
    form = Accounts::CreationForm.new(email: "test")
  ...
  it "メールアドレスがすでに使われているとき、エラーになること" do
    ...
    form = Accounts::CreationForm.new(email: "test@example.com")
  ...
  it "ロケールが空文字列のとき、エラーになること" do
    form = Accounts::CreationForm.new(locale: "")
  ...
  it "ロケールが `nil` のとき、エラーになること" do
    form = Accounts::CreationForm.new(locale: nil)
  ...
  it "ロケールの値が不正なとき、エラーになること" do
    form = Accounts::CreationForm.new(locale: "invalid")
  ...
  it "パスワードが空文字列のとき、エラーになること" do
    form = Accounts::CreationForm.new(password: "")
  ...
  it "パスワードが `nil` のとき、エラーになること" do
    form = Accounts::CreationForm.new(password: nil)
  ...
  it "パスワードが7文字のとき、エラーになること" do
    form = Accounts::CreationForm.new(password: "a" * 7)
  ...
  it "タイムゾーンが空文字列のとき、エラーになること" do
    form = Accounts::CreationForm.new(time_zone: "")
  ...
  it "タイムゾーンが `nil` のとき、エラーになること" do
    form = Accounts::CreationForm.new(time_zone: nil)
  ...
  it "タイムゾーンの形式が不正なとき、エラーになること" do
    form = Accounts::CreationForm.new(time_zone: "invalid")
