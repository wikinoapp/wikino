...
RSpec.describe Profiles::EditForm, type: :form do
  it "アットネームが空文字列のとき、エラーになること" do
    form = Profiles::EditForm.new(atname: "")
  ...
  it "アットネームが `nil` のとき、エラーになること" do
    form = Profiles::EditForm.new(atname: nil)
  ...
  it "アットネームが21文字のとき、エラーになること" do
    form = Profiles::EditForm.new(atname: "a" * 21)
  ...
  it "アットネームが予約語のとき、エラーになること" do
    form = Profiles::EditForm.new(atname: "admin")
  ...
  it "アットネームの形式が不正なとき、エラーになること" do
    form = Profiles::EditForm.new(atname: "a@b")
  ...
  it "アットネームがすでに使われているとき、エラーになること" do
    ...
    form = Profiles::EditForm.new(user_record: user, atname: "already_used_atname")
  ...
  it "名前が31文字のとき、エラーになること" do
    form = Profiles::EditForm.new(name: "a" * 31)
  ...
  it "説明文が151文字のとき、エラーになること" do
    form = Profiles::EditForm.new(description: "a" * 151)
