...
RSpec.describe "Markdownエディター/タブキーによるインデント機能", type: :system do
  ...
  it "タブキーを押すと半角スペース2つが挿入されること", :js do
    visit_page_editor
    clear_editor
  ...
  it "行頭でタブキーを押すと行頭に半角スペース2つが挿入されること", :js do
    visit_page_editor
    clear_editor
    fill_in_editor(text: "テスト")
    # カーソルを行頭に移動
  ...
  it "Shift+タブキーを押すとインデントが削除されること", :js do
    visit_page_editor
    clear_editor
  ...
  it "リスト項目の先頭でタブキーを押すとネストされたリスト項目になること", :js do
    visit_page_editor
    clear_editor
    # リスト項目を作成
  ...
  it "タスクリスト項目の先頭でタブキーを押すとネストされたタスクリスト項目になること", :js do
    visit_page_editor
    clear_editor
    # タスクリスト項目を作成
  ...
  it "既にインデントされたリスト項目でタブキーを押すとさらにネストされること", :js do
    visit_page_editor
    clear_editor
    # インデント付きリスト項目を作成
  ...
  it "行選択 (改行文字を含む) でタブキーを押すと選択した行のみインデントが追加され、カーソル位置が正しく維持されること", :js do
    visit_page_editor
    clear_editor
    # 複数行のテキストを作成
    set_editor_content(text: "- a\n- b\n- c")
  ...
  it "行選択 (改行文字を含む) でShift+タブキーを押すと選択した行のみインデントが削除され、カーソル位置が正しく維持されること", :js do
    visit_page_editor
    clear_editor
    # インデント付きの複数行テキストを作成
    set_editor_content(text: "- a\n  - b\n- c")
  ...
  it "複数行選択 (改行文字を含む) でタブキーを押すと選択した行のみインデントが追加されること", :js do
    visit_page_editor
    clear_editor
    # 複数行のテキストを作成
  ...
  it "行選択でタブキーを押すと選択範囲が維持されること", :js do
    visit_page_editor
    clear_editor
    # 複数行のテキストを作成
    set_editor_content(text: "- a\n- b\n- c")
  ...
  it "行選択でタブキーを押した後、deleteキーで行全体が削除されること", :js do
    visit_page_editor
    clear_editor
    # 複数行のテキストを作成
    set_editor_content(text: "- a\n- b\n- c")
  ...
  it "リスト項目のマーカー直後にテキストがある状態でタブキーを押すとネストされたリストアイテムになること", :js do
    visit_page_editor
    clear_editor
    # リスト項目を作成
    set_editor_content(text: "- a\n- b")
  ...
  it "タスクリスト項目のマーカー直後にテキストがある状態でタブキーを押すとネストされたタスクリストアイテムになること", :js do
    visit_page_editor
    clear_editor
    # タスクリスト項目を作成
    set_editor_content(text: "- [ ] タスク1\n- [ ] タスク2")
  ...
  it "完了タスクリスト項目のマーカー直後にテキストがある状態でタブキーを押すとネストされた完了タスクリストアイテムになること", :js do
    visit_page_editor
    clear_editor
    # 完了タスクリスト項目を作成
