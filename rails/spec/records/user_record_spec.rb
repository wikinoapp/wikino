...
RSpec.describe UserRecord, type: :record do
  describe "#viewable_topics" do
    it "トピックが存在するとき、閲覧可能なトピックを返すこと" do
      ...
      create(:topic_member_record, space_record: space, topic_record: topic_b, space_member_record: space_member)
      create(:topic_member_record, space_record: space, topic_record: topic_c, space_member_record: space_member)
