...
class SpaceMemberRepository < ApplicationRepository
  ...
  def to_model(space_member_record:)
    space = SpaceRepository.new.to_model(space_record: space_member_record.space_record.not_nil!)
    user = UserRepository.new.to_model(user_record: space_member_record.user_record.not_nil!)
