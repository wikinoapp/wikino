...
module Services
  class UpdateNoteService < Services::ApplicationService
    include Services::NoteUpsertable

    sig { params(form: Forms::UpdateNoteForm).void }
    def initialize(form:)
      @form = form
    end
    ...
    sig { returns(Forms::UpdateNoteForm) }
    private def form
      @form
    end
  end
