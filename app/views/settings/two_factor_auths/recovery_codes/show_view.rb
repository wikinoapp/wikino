  ...
  module TwoFactorAuths
    module RecoveryCodes
      class ShowView < ApplicationView
        sig { params(current_user: User, user_two_factor_auth: UserTwoFactorAuth, regeneration_form: T.nilable(TwoFactorAuthForm::RecoveryCodeRegeneration)).void }
        def initialize(current_user:, user_two_factor_auth:, regeneration_form: nil)
