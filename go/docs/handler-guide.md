...
このドキュメントは、Wikino Go版でHTTPハンドラーを実装する際のガイドラインを提供します。
...
import (
    "github.com/wikinoapp/wikino/internal/config"
    repository "github.com/wikinoapp/wikino/internal/repository/sqlc"
)
...
import (
    ...
    "github.com/wikinoapp/wikino/pkg/ratelimit"
...
import (
    "net/http"
    "github.com/wikinoapp/wikino/internal/templates/pages/password_reset"
)
