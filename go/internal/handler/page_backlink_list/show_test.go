...
func TestShow_未ログイン時に401が返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/test-space/pages/1/links/2/backlink_list", map[string]string{
...
func TestShow_存在しないスペースで404が返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/nonexistent/pages/1/links/2/backlink_list", map[string]string{
...
func TestShow_スペースメンバーでない場合に404が返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/backlink-private/pages/1/links/2/backlink_list", map[string]string{
...
func TestShow_不正なページ番号で404が返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/test-space/pages/abc/links/2/backlink_list", map[string]string{
		"space_identifier":   "test-space",
		"page_number":        "abc",
		"linked_page_number": "2",
	})
...
func TestShow_不正なリンク先ページ番号で404が返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/test-space/pages/1/links/abc/backlink_list", map[string]string{
		"space_identifier":   "test-space",
		"page_number":        "1",
...
func TestShow_正常系_バックリンクなしでSSEレスポンスが返る(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/backlink-ok/pages/1/links/2/backlink_list", map[string]string{
...
func TestShow_正常系_バックリンクありでSSEレスポンスにバックリンクが含まれる(t *testing.T) {
	...
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/backlink-has/pages/1/links/2/backlink_list", map[string]string{
...
func TestShow_正常系_ページネーションパラメータが反映される(t *testing.T) {
	...
	// page=1でバックリンクが含まれる
	req := newRequestWithChiParams(t, http.MethodGet, "/go/s/backlink-page/pages/1/links/2/backlink_list?page=1", map[string]string{
	...
	req2 := newRequestWithChiParams(t, http.MethodGet, "/go/s/backlink-page/pages/1/links/2/backlink_list?page=999", map[string]string{
		"space_identifier":   "backlink-page",
		"page_number":        "1",
		"linked_page_number": "2",
	})
