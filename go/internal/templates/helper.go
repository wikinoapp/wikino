...
func Icon(name string, class ...string) templ.Component {
	...
	icons := map[string]string{
		...
		"logo":       `<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80"><rect width="80" height="80" fill="#4f46e5" rx="12"/><text x="40" y="52" text-anchor="middle" fill="white" font-family="system-ui, sans-serif" font-size="32" font-weight="bold">W</text></svg>`,
	}
