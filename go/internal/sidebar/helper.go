...
func (h *Helper) Content(ctx context.Context, userID model.UserID) ([]viewmodel.TopicForSidebar, []viewmodel.DraftPageForSidebar) {
	...
	drafts, err := h.draftPageRepo.ListByUser(ctx, userID, viewmodel.SidebarDraftPagesLimit)
	if err != nil {
