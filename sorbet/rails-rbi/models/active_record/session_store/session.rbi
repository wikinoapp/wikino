...
module ActiveRecord::SessionStore::Session::QueryMethodsReturningRelation
  ...
  sig { params(args: Symbol).returns(ActiveRecord::SessionStore::Session::ActiveRecord_Relation) }
...
module ActiveRecord::SessionStore::Session::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: Symbol).returns(ActiveRecord::SessionStore::Session::ActiveRecord_AssociationRelation) }
  def where_missing(*args); end
