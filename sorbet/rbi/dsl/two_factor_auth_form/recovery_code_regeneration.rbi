...
# This is an autogenerated file for dynamic methods in `TwoFactorAuthForm::RecoveryCodeRegeneration`.
# Please instead update this file by running `bin/tapioca dsl TwoFactorAuthForm::RecoveryCodeRegeneration`.
