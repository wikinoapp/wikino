...
class Topic
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Topic` class because it declared `has_many :pages`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Topic, Integer, String, T::Enumerable[T.any(::Topic, Integer, String, T::Enumerable[::Topic])])
      ).returns(T::Array[::Topic])
    end
