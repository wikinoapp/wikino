...
class Space
  ...
  module GeneratedAssociationMethods
    ...
    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def export_ids=(ids); end

    # This method is created by ActiveRecord on the `Space` class because it declared `has_many :exports`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Export::PrivateCollectionProxy) }
    def exports; end

    sig { params(value: T::Enumerable[::Export]).void }
    ...
    # This method is created by ActiveRecord on the `Space` class because it declared `has_many :page_editors`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    ...
    # This method is created by ActiveRecord on the `Space` class because it declared `has_many :topic_members`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    ...
    # This method is created by ActiveRecord on the `Space` class because it declared `has_many :users`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
