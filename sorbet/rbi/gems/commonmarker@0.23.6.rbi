...
module CommonMarker
  class << self
    ...
    # @raise [TypeError]
    #
    # source://commonmarker//lib/commonmarker.rb#22
...
class CommonMarker::HtmlRenderer < ::CommonMarker::Renderer
  ...
  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#142
  def image(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#120
  def inline_html(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#161
  def linebreak(_node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#136
  def link(node); end
  ...
  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#211
  def strikethrough(_); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#132
  def strong(_); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#175
  def table(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#200
  def table_cell(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#183
  def table_header(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#191
  def table_row(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#66
  def tasklist(node); end

  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#151
  def text(node); end
  ...
  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#235
  def out_footnote_backref; end

  # @return [Boolean]
  #
  # source://commonmarker//lib/commonmarker/renderer/html_renderer.rb#244
  def tasklist?(node); end
end
