...
class RuboCop::Cop::Lint::AssignmentInCondition < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.69.1/lib/rubocop/cop/lint/assignment_in_condition.rb#55
  def on_if(node); end
  ...
  # source://rubocop/1.69.1/lib/rubocop/cop/lint/assignment_in_condition.rb#82
  def allowed_construct?(asgn_node); end

  # source://rubocop/1.69.1/lib/rubocop/cop/lint/assignment_in_condition.rb#86
  def conditional_assignment?(asgn_node); end

  # source://rubocop/1.69.1/lib/rubocop/cop/lint/assignment_in_condition.rb#90
  def skip_children?(asgn_node); end

  # source://rubocop/1.69.1/lib/rubocop/cop/lint/assignment_in_condition.rb#96
  def traverse_node(node, &block); end
end

# source://standard//lib/standard/rubocop/ext.rb#9
class RuboCop::DirectiveComment
  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#32
  def initialize(comment, cop_registry = T.unsafe(nil)); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#82
  def all_cops?; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#30
  def comment; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#87
  def cop_names; end
  ...
  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#93
  def department_names; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#107
  def directive_count; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#62
  def disabled?; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#77
  def disabled_all?; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#67
  def enabled?; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#72
  def enabled_all?; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#98
  def in_directive_department?(cop); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#112
  def line_number; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#44
  def match?(cop_names); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#57
  def match_captures; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#30
  def mode; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#103
  def overridden_by_department?(cop); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#48
  def range; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#39
  def single_line?; end

  private

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#133
  def all_cop_names; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#137
  def cop_names_for_department(department); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#129
  def department?(name); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#142
  def exclude_lint_department_cops(cops); end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#122
  def parsed_cop_names; end

  # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#118
  def splitted_cops_string; end

  class << self
    # source://rubocop/1.69.1/lib/rubocop/directive_comment.rb#26
