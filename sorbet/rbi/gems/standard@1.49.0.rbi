...
class RuboCop::Cop::Lint::AssignmentInCondition < ::RuboCop::Cop::Base
  ...
  # source://rubocop/1.75.5/lib/rubocop/cop/lint/assignment_in_condition.rb#55
  def on_if(node); end
  ...
  # source://rubocop/1.75.5/lib/rubocop/cop/lint/assignment_in_condition.rb#80
  def allowed_construct?(asgn_node); end

  # source://rubocop/1.75.5/lib/rubocop/cop/lint/assignment_in_condition.rb#84
  def conditional_assignment?(asgn_node); end

  # source://rubocop/1.75.5/lib/rubocop/cop/lint/assignment_in_condition.rb#88
  def skip_children?(asgn_node); end

  # source://rubocop/1.75.5/lib/rubocop/cop/lint/assignment_in_condition.rb#94
