...
class RQRCodeCore::QRCode
  ...
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#212
  ...
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#207
  def inspect; end

  # Return a symbol in QRMODE.keys for current mode used
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#222
  def mode; end
  ...
  # @return [Boolean]
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#217
  ...
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#178
  def to_s(*args); end
  ...
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#235
  def make; end

  private

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#418
  def extract_options!(arr); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#286
  def get_best_mask_pattern; end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#254
  def make_impl(test, mask_pattern); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#367
  def map_data(data, mask_pattern); end

  # @raise [QRCodeRunTimeError]
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#406
  def minimum_version(limit: T.unsafe(nil), version: T.unsafe(nil)); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#335
  def place_format_info(test, mask_pattern); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#308
  def place_position_adjust_pattern; end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#269
  def place_position_probe_pattern(row, col); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#302
  def place_timing_pattern; end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#325
  def place_version_info(test); end

  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#242
  def prepare_common_patterns; end

  class << self
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#423
    def count_max_data_bits(rs_blocks); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#448
    def create_bytes(buffer, rs_blocks); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#431
...
class RQRCodeCore::QRUtil
  class << self
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#163
    def demerit_points_1_same_color(modules); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#194
    def demerit_points_2_full_blocks(modules); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#215
    def demerit_points_3_dangerous_patterns(modules); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#251
    ...
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#75
    def get_bch_format_info(data); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#88
    ...
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#129
    def get_length_in_bits(mode, version); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#152
    def get_lost_points(modules); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#111
    def get_mask(mask_pattern, i, j); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#107
    def get_pattern_positions(version); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#71
    def max_size; end
...
#
# source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#69
