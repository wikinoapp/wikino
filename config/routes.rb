...
Rails.application.routes.draw do
  ...
  match "/s::space_identifier/nb::notebook_identifier", via: :get,    as: :notebook,                to: "notebooks/show#call"
  match "/s::space_identifier/notebooks",               via: :post,   as: :notebook_list,           to: "notebooks/create#call"
