...
module T
  module Wikino
    ...
    TopicContextPolicyInstance = T.type_alias { T.any(SpaceOwnerPolicy, SpaceMemberPolicy, SpaceGuestPolicy, TopicOwnerPolicy, TopicAdminPolicy, TopicMemberPolicy, TopicGuestPolicy) }
  end
end
