...
CREATE TABLE public.teams (
    ...
    updated_at timestamp(6) without time zone NOT NULL,
    deleted_at timestamp without time zone,
    teamname public.citext NOT NULL,
    name character varying DEFAULT ''::character varying NOT NULL
);
...
--
-- Name: index_participants_on_note_id_and_team_member_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_participants_on_note_id_and_team_member_id ON public.participants USING btree (note_id, team_member_id);


--
-- Name: index_participants_on_team_member_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_participants_on_team_member_id ON public.participants USING btree (team_member_id);
...
--
-- Name: index_projects_on_team_id_and_projectname; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_projects_on_team_id_and_projectname ON public.projects USING btree (team_id, projectname);
...
--
-- Name: index_teams_on_teamname; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_teams_on_teamname ON public.teams USING btree (teamname);
...
ALTER TABLE ONLY public.notes
    ADD CONSTRAINT fk_rails_5d4a723a34 FOREIGN KEY (creator_id) REFERENCES public.team_members(id);
...
--
-- Name: participants fk_rails_d0624ef8cf; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.participants
    ADD CONSTRAINT fk_rails_d0624ef8cf FOREIGN KEY (team_member_id) REFERENCES public.team_members(id);
