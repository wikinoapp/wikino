...
RSpec.describe TopicRepository do
  describe "#find_topics_by_space" do
    it "スペースに参加しているトピックをlast_page_modified_atの降順で返すこと" do
      ...
      space_member_record = FactoryBot.create(:space_member_record, user_record:, space_record:, role: SpaceMemberRole::Owner.serialize)
    ...
    it "current_user_recordがnilの場合、権限フラグがfalseになること" do
      # テスト用のデータ作成
      user_record = FactoryBot.create(:user_record)
      space_record = FactoryBot.create(:space_record)
