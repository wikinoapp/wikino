...
RSpec.describe "Global Hotkey", type: :system do
  it "検索ページ以外でsキーまたは/キーを押すと検索ページに遷移すること", js: true do
  ...
  it "スペース内でsキーまたは/キーを押すとspace:フィルターが付与された検索ページに遷移すること", js: true do
    user_record = create(:user_record, :with_password)
  ...
  it "トピック内でsキーまたは/キーを押すとspace:フィルターが付与された検索ページに遷移すること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
  ...
  it "ページ内でsキーまたは/キーを押すとspace:フィルターが付与された検索ページに遷移すること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    create(:space_member_record, user_record:, space_record:)
  ...
  it "ページ編集画面でsキーまたは/キーを押すとspace:フィルターが付与された検索ページに遷移すること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
