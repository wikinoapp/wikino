...
RSpec.describe "Markdownエディター/ファイルアップロード機能", type: :system do
  ...
  it "ページ編集画面でファイルをアップロードできること", js: true do
  ...
  it "複数のファイルを同時にアップロードできること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    space_member_record = create(:space_member_record, user_record:, space_record:)
  ...
  it "エディタにファイルをドラッグ&ドロップできること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    space_member_record = create(:space_member_record, user_record:, space_record:)
  ...
  it "ドラッグ中にドロップゾーンが表示されること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    space_member_record = create(:space_member_record, user_record:, space_record:)
  ...
  it "ファイルサイズが制限を超えている場合、エラーメッセージが表示されること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    space_member_record = create(:space_member_record, user_record:, space_record:)
  ...
  it "サポートされていないファイル形式の場合、エラーメッセージが表示されること", js: true do
    user_record = create(:user_record, :with_password)
    space_record = create(:space_record, identifier: "test-space")
    topic_record = create(:topic_record, space_record:)
    space_member_record = create(:space_member_record, user_record:, space_record:)
