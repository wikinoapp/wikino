...
RSpec.describe TopicForm::Creation, type: :form do
  it "名前が空文字列のとき、エラーになること" do
    form = TopicForm::Creation.new(name: "")
  ...
  it "名前が `nil` のとき、エラーになること" do
    form = TopicForm::Creation.new(name: nil)
  ...
  it "名前が31文字のとき、エラーになること" do
    form = TopicForm::Creation.new(name: "a" * 31)
  ...
  it "名前がすでに使われているとき、エラーになること" do
    ...
    form = TopicForm::Creation.new(space_record: space, name: topic.name)
  ...
  it "名前が30文字のとき、エラーにならないこと" do
    space = create(:space_record)
    form = TopicForm::Creation.new(space_record: space, name: "a" * 30, description: "test", visibility: "public")
  ...
  it "名前が別のスペースで使われているとき、エラーにならないこと" do
    ...
    form = TopicForm::Creation.new(space_record: space_1, name: "トピック", description: "test", visibility: "public")
