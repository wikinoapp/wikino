...
RSpec.describe NewTopicForm, type: :form do
  ...
  it "名前がすでに使われているとき、エラーになること" do
    ...
    form = NewTopicForm.new(space_record: space, name: topic.name)
  ...
  it "名前が30文字のとき、エラーにならないこと" do
    space = create(:space_record)
    form = NewTopicForm.new(space_record: space, name: "a" * 30, description: "test", visibility: "public")
  ...
  it "名前が別のスペースで使われているとき、エラーにならないこと" do
    ...
    form = NewTopicForm.new(space_record: space_1, name: "トピック", description: "test", visibility: "public")
