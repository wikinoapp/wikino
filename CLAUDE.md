...
Claude Code とのやり取りは日本語で行ってください。
...
Go 版の具体的なコマンドは `go/CLAUDE.md` の「コミット前に実行するコマンド」セクションを参照してください。
Rails 版の具体的なコマンドは `rails/CLAUDE.md` の「コミット前に実行するコマンド」セクションを参照してください。
