...
--
-- Name: index_active_storage_attachments_on_space_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_active_storage_attachments_on_space_id ON public.active_storage_attachments USING btree (space_id);
...
--
-- Name: index_active_storage_blobs_on_space_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_active_storage_blobs_on_space_id ON public.active_storage_blobs USING btree (space_id);


--
-- Name: index_active_storage_variant_records_on_space_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_active_storage_variant_records_on_space_id ON public.active_storage_variant_records USING btree (space_id);
...
--
-- Name: active_storage_attachments fk_rails_118627d226; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.active_storage_attachments
    ADD CONSTRAINT fk_rails_118627d226 FOREIGN KEY (space_id) REFERENCES public.spaces(id);
...
--
-- Name: active_storage_variant_records fk_rails_40c47dca11; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.active_storage_variant_records
    ADD CONSTRAINT fk_rails_40c47dca11 FOREIGN KEY (space_id) REFERENCES public.spaces(id);


--
-- Name: active_storage_blobs fk_rails_44f6bbdaf7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.active_storage_blobs
    ADD CONSTRAINT fk_rails_44f6bbdaf7 FOREIGN KEY (space_id) REFERENCES public.spaces(id);
