...
class InitialTables < ActiveRecord::Migration[7.1]
  def change
    ...
    create_table :team_projects, id: false do |t|
      t.uuid :id, default: "generate_ulid()", null: false, primary_key: true
      t.references :team, foreign_key: true, null: false, type: :uuid
      t.references :project, foreign_key: true, null: false, type: :uuid

      t.index %i[team_id project_id], unique: true
    end
    ...
    create_table :note_contents, id: false do |t|
      t.uuid :id, default: "generate_ulid()", null: false, primary_key: true
      t.references :note, foreign_key: true, index: {unique: true}, null: false, type: :uuid
      t.citext :body, null: false, default: ""
      t.text :body_html, null: false, default: ""
      t.timestamps
    end

    create_table :past_note_contents, id: false do |t|
      t.uuid :id, default: "generate_ulid()", null: false, primary_key: true
