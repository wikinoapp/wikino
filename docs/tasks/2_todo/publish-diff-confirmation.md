...
ページ公開前にDraftPageの内容とPageの現在の公開版との差分を確認できる機能を実装する。ユーザーが公開操作を行う前に、本文およびタイトルの変更内容を視覚的に確認できるようにする。

Rails版にはこの機能が存在しないため、Go版での新規実装となる。
...
- ユーザーは公開前にDraftPageの内容とPageの現在の内容との差分を確認できる（本文およびタイトル）
...
- [ ] **N-1**: 仕様書の作成・更新
  - `docs/specs/page/edit.md` の仕様書に公開前の差分確認の内容を追記する
