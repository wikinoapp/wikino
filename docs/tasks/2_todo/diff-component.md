...
- 前提: [@docs/tasks/2_todo/page-edit-go-migration.md](page-edit-go-migration.md) - ページ編集画面のGo移行（差分表示の対象となるモデルが必要）

### 関連タスク

- [@docs/tasks/2_todo/edit-suggestion.md](edit-suggestion.md) - 編集提案機能
- [@docs/tasks/2_todo/draft-screens.md](draft-screens.md) - 下書き詳細画面・下書き一覧画面
