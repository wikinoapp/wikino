...
- [ ] **1-1**: [Go] DraftPageRevision のDBマイグレーションとモデル定義
...
- [ ] **1-2**: [Go] DraftPageRevision の sqlc クエリとリポジトリ
...
- [ ] **2-1**: [Go] CreateDraftPageRevision Usecase の実装
  - `internal/usecase/create_draft_page_revision.go` に Usecase 実装
