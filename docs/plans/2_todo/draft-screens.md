...
- 前提: [@docs/plans/2_todo/draft-page-revision.md](draft-page-revision.md) - DraftPageRevision の実装
- 前提: [@docs/plans/2_todo/diff-component.md](diff-component.md) - 差分表示コンポーネント
...
UI設計の詳細は [@docs/plans/2_todo/edit-suggestion.md](edit-suggestion.md) の「UI設計」セクションを参照。
